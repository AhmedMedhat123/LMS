              ...
              <div className="media media-card align-items-center pb-4">
                <div className="media-img media--img media-img-md rounded-full">
                  <img
                    ...
                    src={
                      instructor.photo
                        ? `/upload/instructor_images/${instructor.photo}`
                ...
                <div className="media-body">
                  <h2 className="section__title fs-30">{instructor.name}</h2>
                  <p className="lh-18 mt-2">{instructor.email}</p>
                </div>
              </div>
            </div>
              ...
              <div className="row">
                <div className="col-lg-4 responsive-column-half">
                  <div className="counter-item">
                    ...
                    <h4 className="counter__title counter text-color-2 fs-35">
                      1,515,351
                    </h4>
                    <p className="counter__meta">Total Students</p>
                  </div>
                  {/* end counter-item */}
                </div>
                {/* end col-lg-4 */}
                <div className="col-lg-4 responsive-column-half">
                  <div className="counter-item">
                    ...
                    <h4 className="counter__title counter text-color-3 fs-35">
                      515,351
                    </h4>
                    <p className="counter__meta">Reviews</p>
                  </div>
                  {/* end counter-item */}
                </div>
                {/* end col-lg-4 */}
                <div className="col-lg-4 responsive-column-half">
                  <div className="counter-item">
                    ...
                    <h4 className="counter__title counter text-color-4 fs-35">
                      24
                    </h4>
                    <p className="counter__meta">Courses</p>
                  </div>
                  {/* end counter-item */}
                </div>
                {/* end col-lg-4 */}
        ...
        <section className="course-area section-padding">
          <div className="container">
            <div className="d-flex align-items-center justify-content-between pb-3">
              <h3 className="fs-24 font-weight-semi-bold">My courses</h3>
              <span className="ribbon ribbon-lg">24</span>
            </div>
