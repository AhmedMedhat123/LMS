                    ...
                    <div className="container-fluid">
                        <div className="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between mb-5">
                            ...
                            <div className="file-upload-wrap file-upload-wrap-2 file--upload-wrap">
                                ...
                                <span className="file-upload-text"><i className="la la-upload mr-2" />Upload a course</span>
                                ...
                                <div className="card card-item dashboard-info-card">
                                    <div className="card-body d-flex align-items-center">
                                        <div className="icon-element flex-shrink-0 bg-1 text-white">
                                            <svg className="svg-icon-color-white" width={40} xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 512 512" xmlSpace="preserve">
                                                <g>
                                ...
                                <div className="card card-item dashboard-info-card">
                                    <div className="card-body d-flex align-items-center">
                                        <div className="icon-element flex-shrink-0 bg-2 text-white">
                                            <svg className="svg-icon-color-white" width={40} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" xmlSpace="preserve">
                                                <g>
                                                    <g>
                                                        <g>
                                ...
                                <div className="card card-item dashboard-info-card">
                                    <div className="card-body d-flex align-items-center">
                                        <div className="icon-element flex-shrink-0 bg-4 text-white">
                                            <svg className="svg-icon-color-white" width={40} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 490.667 490.667" xmlSpace="preserve">
                                                <g>
                                                    <g>
