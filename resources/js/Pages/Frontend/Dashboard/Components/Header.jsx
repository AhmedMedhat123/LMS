    ...
    return (
        <>
            <header className="header-menu-area">
                                                        ...
                                                        <li>
                                                            ...
                                                            <ul className="cart-dropdown-menu after-none">
                                                                <li className="media media-card">
                                                                    <a href="lesson-details.html" className="media-img">
                                                                        <img className="mr-3" src="assets/images/small-img-3.jpg" alt="Course thumbnail image" />
                                                                    </a>
                                                                ...
                                                                <li className="media media-card">
                                                                    <a href="lesson-details.html" className="media-img">
                                                                        <img className="mr-3" src="assets/images/small-img-4.jpg" alt="Course thumbnail image" />
                                                                    </a>
                                                                    <div className="media-body">
                                                                        <h5><a href="lesson-details.html">The Complete JavaScript Course 2021: From Zero to Expert!</a></h5>
                                                                        <div className="skillbar-box pt-3">
                                                                            <div className="skillbar skillbar-skillbar" data-percent="77%">
                                                                                <div className="skillbar-bar skillbar--bar bg-1" />
                                                                            </div>{/* End Skill Bar */}
                                                                        </div>{/* End skillbar-box */}
                                                                    </div>
                                                                ...
                                                                <li>
                                                                    <a href="my-courses.html" className="btn theme-btn w-100">Got to my course <i className="la la-arrow-right icon ml-1" /></a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                                            ...
                                                            <ul className="cart-dropdown-menu after-none">
                                                                <li className="media media-card">
                                                                    <a href="shopping-cart.html" className="media-img">
                                                                        <img className="mr-3" src="assets/images/small-img.jpg" alt="Cart image" />
                                                                    </a>
                                                                    <div className="media-body">
                                                        ...
                                                        <li>
                                                            ...
                                                            <ul className="cart-dropdown-menu after-none">
                                                                <li>
                                                                    ...
                                                                    <a href="#" className="btn theme-btn theme-btn-sm theme-btn-transparent lh-28 w-100 mt-3">Add to cart <i className="la la-arrow-right icon ml-1" /></a>
                                                                </li>
                                                                <li>
                                                                    <div className="media media-card">
                                                                        <a href="course-details.html" className="media-img">
                                                                ...
                                                                <li>
                                                                    <a href="my-courses.html" className="btn theme-btn w-100">Got to wishlist <i className="la la-arrow-right icon ml-1" /></a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <ul className="cart-dropdown-menu after-none p-0 notification-dropdown-menu">
                                                                ...
                                                                <li className="menu-heading-block">
                                                                    <a href="dashboard.html" className="btn theme-btn w-100">Show All Notifications <i className="la la-arrow-right icon ml-1" /></a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                                                    ...
                                                                    <ul className="generic-list-item">
                                                                        <li>
                                                                            <a href="my-courses.html">
                                                                                <i className="la la-file-video-o mr-1" /> My courses
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="shopping-cart.html">
                                                                                <i className="la la-shopping-basket mr-1" /> My cart
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="my-courses.html">
                                                                                <i className="la la-heart-o mr-1" /> My wishlist
                                                                            </a>
                                                                        </li>
                                                                        <li><div className="section-block" /></li>
                                                                        <li>
                                                                            <a href="dashboard.html">
                                                                                <i className="la la-bell mr-1" /> Notifications
                                                                                <span className="badge bg-info text-white ml-2 p-1">9+</span>
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="dashboard-message.html">
                                                                                <i className="la la-envelope mr-1" /> Messages
                                                                        ...
                                                                        <li>
                                                                            <a href="dashboard-purchase-history.html">
                                                                                <i className="la la-history mr-1" /> Purchase history
                                                                            </a>
                                                                        </li>
                                                                        <li><div className="section-block" /></li>
                                                                        <li>
                                                                            <a href="student-detail.html">
                                                                                <i className="la la-user mr-1" /> Public profile
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="dashboard-settings.html">
                                                                                <i className="la la-edit mr-1" /> Edit profile
                                                                            </a>
                                                                        </li>
                                                                        <li><div className="section-block" /></li>
                                                                        <li>
                                                                            <a href="#">
                                                                                <i className="la la-question mr-1" /> Help
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="index.html">
                ...
                <div className={`body-overlay  ${sidebarActive ? "active" : ""}`} onClick={() => setSidebarActive(false)} />
            </header>
