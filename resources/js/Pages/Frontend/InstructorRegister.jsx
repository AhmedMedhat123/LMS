...
const InstructorRegister = () => {
  ...
  START FEATURE AREA
 ======================================*/}
                    <section className="feature-area section--padding bg-gray">
                        <div className="container">
                            <div className="feature-heading-content-wrap text-center">
                                ...
                                <div className="col-lg-4 responsive-column-half">
                                  ...
                                  C178.001,264.477,173.524,260,168.001,260z M158.001,308h-28v-28h28V308z"
                                        ...
                                        <p className="info__text">
                                            Whether you want to develop as a
                                            professional or discover a new
                                            hobby, there's an online course for
                                            that.
                                        </p>
                                    </div>
                                    {/* end info-box */}
                                    ...
                                    <div className="info-box before-none">
                                        <div className="icon-element mx-auto shadow-sm">
                                            <svg
                                                ...
                                                xmlns="http://www.w3.org/2000/svg"
                                            >
                                                <path d="m472 0h-448c-13.230469 0-24 10.769531-24 24v352c0 13.230469 10.769531 24 24 24h448c13.230469 0 24-10.769531 24-24v-352c0-13.230469-10.769531-24-24-24zm8 376c0 4.414062-3.59375 8-8 8h-448c-4.40625 0-8-3.585938-8-8v-352c0-4.40625 3.59375-8 8-8h448c4.40625 0 8 3.59375 8 8zm0 0" />
                                                ...
                                                <path d="m32 364.945312 73.886719-36.945312-73.886719-36.945312zm16-48 22.113281 11.054688-22.113281 11.054688zm0 0" />
...
======================================*/}
                    <section className="register-area section--padding dot-bg overflow-hidden">
                        <div className="container">
                            <div className="register-heading-content-wrap text-center">
                                <div className="section-heading">
                                    <h2 className="section__title">
                                            ...
                                            <form method="post" className="row">
                                                ...
                                                <div className="input-box col-lg-6">
                                                    ...
                                                    <div className="form-group">
                                                        <input
                                                            ...
                                                            placeholder="City"
                                                        />
                                                        <span className="la la-map input-icon" />
                                                    </div>
                                                </div>
                                                {/* end input-box */}
                                                <div className="input-box col-lg-6">
                                                ...
                                                <div className="input-box col-lg-12">
                                                    ...
                                                    <div className="form-group d-flex align-items-center">
                                                        <div className="custom-control custom-radio fs-15 mr-3">
                                                            <input
                                                                type="radio"
                                                            ...
                                                            <label
                                                                ...
                                                                htmlFor="maleRadioCheck"
                                                            >
                                                                Male
                                                            </label>
                                                        </div>
                                                        <div className="custom-control custom-radio fs-15">
                                                            <input
                                                                type="radio"
                                                                className="custom-control-input"
                                                                id="femaleRadioCheck"
