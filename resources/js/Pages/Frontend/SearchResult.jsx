...
const SearchResult = ({ courses, searchContent }) => {
            ...
            <div className="py-6">
              {courses.data.length > 0 ? (
                <h1 className="text-2xl font-bold text-gray-800">
                  {courses.data.length} result
                  {courses.data.length > 1 ? 's' : ''} for "{searchContent}"
                </h1>
              ) : (
                <h1 className="text-2xl font-semibold text-center text-red-600">
                  Sorry, we couldn't find any results for{' '}
                  <span className="text-gray-800">"{searchContent}"</span>
                </h1>
              )}
            </div>
