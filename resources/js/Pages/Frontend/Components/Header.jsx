                            ...
                            <div className="col-lg-6">
                                <div className="header-widget">
                                    <ul className="generic-list-item d-flex flex-wrap align-items-center fs-14">
                                        <li className="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i className="la la-phone mr-1" /><a href="tel:00123456789"> (00) 123 456 789</a></li>
                                        <li className="d-flex align-items-center"><i className="la la-envelope-o mr-1" /><a href="mailto:contact@aduca.com"> contact@aduca.com</a></li>
                                    </ul>
                                ...
                                <div className="col-lg-10">
                                    <div className="menu-wrapper">
                                        <div className="menu-category">
                                            <ul>
                                                <li>
                                                    <a href="#">Categories <i className="la la-angle-down fs-12" /></a>
                                                    <ul className="cat-dropdown-menu">
                                                        <li>
                                                            <a href="course-grid.html">Development <i className="la la-angle-right" /></a>
                                                        ...
                                                        <li>
                                                            <a href="course-grid.html">business <i className="la la-angle-right" /></a>
                                                            <ul className="sub-menu">
                                                        ...
                                                        <li>
                                                            <a href="course-grid.html">IT &amp; Software <i className="la la-angle-right" /></a>
                                                            <ul className="sub-menu">
                                                        ...
                                                        <li>
                                                            <a href="course-grid.html">Finance &amp; Accounting <i className="la la-angle-right" /></a>
                                                            <ul className="sub-menu">
                                                        ...
                                                        <li>
                                                            <a href="course-grid.html">design <i className="la la-angle-right" /></a>
                                                            <ul className="sub-menu">
                                                        ...
                                                        <li>
                                                            <a href="course-grid.html">Personal Development <i className="la la-angle-right" /></a>
                                                            <ul className="sub-menu">
                                                        ...
                                                        <li>
                                                            <a href="course-grid.html">Marketing <i className="la la-angle-right" /></a>
                                                            <ul className="sub-menu">
                                                        ...
                                                        <li>
                                                            <a href="course-grid.html">Health &amp; Fitness <i className="la la-angle-right" /></a>
                                                            <ul className="sub-menu">
                                                        ...
                                                        <li>
                                                            <a href="course-grid.html">Photography <i className="la la-angle-right" /></a>
                                                            <ul className="sub-menu">
                                        ...
                                        <nav className="main-menu">
                                            <ul>
                                                <li>
                                                    <a href="#">Home <i className="la la-angle-down fs-12" /></a>
                                                ...
                                                <li>
                                                    <a href="#">courses <i className="la la-angle-down fs-12" /></a>
                                                    <ul className="dropdown-menu-item">
                                                ...
                                                <li>
                                                    <a href="#">Student <i className="la la-angle-down fs-12" /></a>
                                                    <ul className="dropdown-menu-item">
                                                ...
                                                <li className="mega-menu-has">
                                                    <a href="#">pages <i className="la la-angle-down fs-12" /></a>
                                                            ...
                                                            <li className="col-lg-3">
                                                                <div className="menu-banner position-relative h-100">
                                                                    ...
                                                                    <div className="menu-banner-content p-4 position-absolute bottom-0 left-0">
                                                                        ...
                                                                        <a href="sign-up.html" className="btn theme-btn theme-btn-sm theme-btn-white">Start Learning <i className="la la-arrow-right icon ml-1" /></a>
                                                                    </div>
                                                                    <img src="assets/images/menu-banner-img.jpg" alt="menu banner image" className="w-100 h-100 rounded-rounded" />
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <li>
                                                    <a href="#">blog <i className="la la-angle-down fs-12" /></a>
                                                    <ul className="dropdown-menu-item">
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <ul className="cart-dropdown-menu">
                                                        ...
                                                        <li>
                                                            <a href="shopping-cart.html" className="btn theme-btn w-100">Got to cart <i className="la la-arrow-right icon ml-1" /></a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        ...
                                        <div className="nav-right-button">
                                            <a href="admission.html" className="btn theme-btn d-none d-lg-inline-block"><i className="la la-user-plus mr-1" /> Admission</a>
