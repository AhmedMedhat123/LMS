                        ...
                        <div className="col-lg-3 responsive-column-half">
                            <div className="footer-item">
                                ...
                                <ul className="generic-list-item pt-4">
                                    ...
                                    <li>
                                        Melbourne, Australia, 105 South Park
                                        Avenue
                                    </li>
                                </ul>
                                <h3 className="fs-20 font-weight-semi-bold pt-4 pb-2">
                                    We are on
                                </h3>
                            ...
                            <div className="footer-item">
                                ...
                                <div className="mobile-app">
                                    <p className="pb-3 lh-24">
                                        Download our mobile app and learn on the
                                        go.
                                    </p>
                                    <a
                                        href="#"
                                        className="d-block mb-2 hover-s"
                                    >
                                        <img
