                    ...
                    <div className="row feature-content-wrap">
                        <div className="col-lg-4 responsive-column-half">
                            <div className="info-box">
                                ...
                                <div className="icon-element mx-auto shadow-sm">
                                    <svg className="svg-icon-color-1" width={41} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 490.667 490.667" xmlSpace="preserve">
                                        <g>
                                            <g>
                                ...
                                <p className="info__text">Timply dummy text of the printing and typesetting industry. Lorem Ipsum
                                </p>
                            </div>{/* end info-box */}
                        </div>{/* end col-lg-3 */}
                        <div className="col-lg-4 responsive-column-half">
                            <div className="info-box">
                                <div className="info-overlay" />
                                <div className="icon-element mx-auto shadow-sm">
                                    <svg className="svg-icon-color-2" viewBox="0 0 74 74" width={45} xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="col-lg-4 responsive-column-half">
                            <div className="info-box">
                                <div className="info-overlay" />
                                <div className="icon-element mx-auto shadow-sm">
                                    <svg className="svg-icon-color-3" viewBox="0 0 74 74" width={50} xmlns="http://www.w3.org/2000/svg">
