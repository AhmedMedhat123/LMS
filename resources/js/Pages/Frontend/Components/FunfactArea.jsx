                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-3 responsive-column-half">
                            <div className="counter-item">
                                <div className="counter__icon icon-element mb-3 shadow-sm">
                                    <svg className="svg-icon-color-1" width={40} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                        ...
                        <div className="col-lg-3 responsive-column-half">
                            <div className="counter-item">
                                <div className="counter__icon icon-element mb-3 shadow-sm">
                                    <svg className="svg-icon-color-2" width={42} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 480.1 480.1" xmlSpace="preserve">
                                        <g>
                                            <g>
                        ...
                        <div className="col-lg-3 responsive-column-half">
                            <div className="counter-item">
                                <div className="counter__icon icon-element mb-3 shadow-sm">
                                    <svg className="svg-icon-color-4" width={40} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                        <g>
