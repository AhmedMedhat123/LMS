                            ...
                            <div className="about-content pb-5">
                                ...
                                <div className="row pt-4 pb-3">
                                    <div className="col-lg-4 responsive-column-half">
                                        <div className="info-icon-box mb-3">
                                            <div className="icon-element icon-element-md shadow-sm">
                                                <svg className="svg-icon-color-1" width={32} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                                    <g>
                                    ...
                                    <div className="col-lg-4 responsive-column-half">
                                        <div className="info-icon-box mb-3">
                                            <div className="icon-element icon-element-md shadow-sm">
                                                <svg className="svg-icon-color-2" width={32} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                                    <g>
                                    ...
                                    <div className="col-lg-4 responsive-column-half">
                                        <div className="info-icon-box mb-3">
                                            <div className="icon-element icon-element-md shadow-sm">
                                                <svg className="svg-icon-color-3" width={32} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 490.667 490.667" xmlSpace="preserve">
                                                    <g>
                                                        <g>
                                ...
                                <div className="btn-box">
                                    <a href="about.html" className="btn theme-btn">Learn More <i className="la la-arrow-right icon ml-1" /></a>
                                </div>{/* end btn-box */}
                            </div>{/* end about-content */}
                        </div>{/* end col-lg-6 */}
                        <div className="col-lg-5 ml-auto">
                            <div className="generic-img-box">
                                <img src="assets/images/img-loading.png" data-src="assets/images/img13.jpg" alt="About image" className="img__item img__item-1 lazy" />
                                <img src="assets/images/img-loading.png" data-src="assets/images/img14.jpg" alt="About image" className="img__item img__item-2 lazy" />
