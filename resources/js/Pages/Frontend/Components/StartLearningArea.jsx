                            ...
                            <div className="card card-item hover-s text-center">
                                <div className="card-body">
                                    <img
                                        ...
                                        data-src="assets/images/small-img-2.jpg"
                                        alt="card image"
                                        className="img-fluid rounded-full lazy"
                                    />
                                    ...
                                    <div className="btn-box mt-20px">
                                        <Link
                                            ...
                                            className="btn theme-btn theme-btn-sm theme-btn-white lh-30"
                                        >
                        ...
                        <div className="col-lg-4 responsive-column-half">
                            <div className="card card-item hover-s text-center">
                                <div className="card-body">
                                    <img
                                        src="assets/images/img-loading.png"
                                        data-src="assets/images/small-img-3.jpg"
                                        alt="card image"
                                        className="img-fluid rounded-full lazy"
                                    />
                                    <h5 className="card-title pt-4 pb-2">
                                    ...
                                    <div className="btn-box mt-20px">
                                        <a
                                            ...
                                            className="btn theme-btn theme-btn-sm theme-btn-white lh-30"
                                        >
                                            <i className="la la-file-text-o mr-1" />
                                            Start Learning
                                        </a>
                                    </div>
                                    {/* end btn-box */}
                        ...
                        <div className="col-lg-4 responsive-column-half">
                            <div className="card card-item hover-s text-center">
                                <div className="card-body">
                                    <img
                                        src="assets/images/img-loading.png"
                                        data-src="assets/images/small-img-4.jpg"
                                        alt="card image"
                                        className="img-fluid rounded-full lazy"
                                    />
                                    <h5 className="card-title pt-4 pb-2">
                                    ...
                                    <p className="card-text">
                                        Get unlimited access to 5,000+ of
                                        Aduca's top courses for your team
                                    </p>
                                    <div className="btn-box mt-20px">
                                        <a
                                            ...
                                            className="btn theme-btn theme-btn-sm theme-btn-white lh-30"
                                        >
                                            <i className="la la-briefcase mr-1" />
                                            Get aduca for business
                                        </a>
                                    </div>
                                    {/* end btn-box */}
                                </div>
