...
const DataTable = ({ data }) => {
  ...
  const columns = useMemo(
    () => [
      ...
      { Header: 'Coupon Name', accessor: 'coupon_name' },
      { Header: 'Coupon Discount', accessor: 'coupon_discount' },
      { Header: 'Coupon Validity', accessor: 'coupon_validity' },
  ...
  return (
    <div className="overflow-x-auto">
      <div className="mb-4 flex flex-col md:flex-row justify-between items-center gap-2">
        ...
        />
        <Link href={route('admin.coupon.add')} className="btn btn-primary mr-1">
          Add Coupon
        </Link>
      </div>
