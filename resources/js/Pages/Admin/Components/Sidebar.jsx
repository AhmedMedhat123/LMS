    ...
    <>
      ...
      >
        ...
        <ul className="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
          <li
            className={url.startsWith('/admin/dashboard') ? 'page-active' : ''}
          >
          ...
          <li className={url.startsWith('/admin/profile') ? 'page-active' : ''}>
          ...
          <li className="relative">
            ...
            >
              ...
              <svg
                className={`ml-auto transform transition-transform ${
                  dropdownOpen.category ? 'rotate-180' : 'rotate-0'
                }`}
                xmlns="http://www.w3.org/2000/svg"
                height="18px"
                viewBox="0 0 24 24"
            ...
            >
              <li
                className={
                  url.startsWith('/admin/category') ? 'page-active' : ''
                }
              >
                <Link
              ...
              <li
                className={
                  url.startsWith('/admin/subcategory') ? 'page-active' : ''
                }
              >
                <Link
          ...
          <li className="relative">
            ...
            >
              ...
              <svg
                className={`ml-auto transform transition-transform ${
                  dropdownOpen.instructor ? 'rotate-180' : 'rotate-0'
                }`}
                xmlns="http://www.w3.org/2000/svg"
                height="18px"
                viewBox="0 0 24 24"
            ...
            >
              <li
                className={
                  url.startsWith('/admin/instructor') ? 'page-active' : ''
                }
              >
                <Link
          ...
          <li className="relative">
            ...
            >
              ...
              <svg
                className={`ml-auto transform transition-transform ${
                  dropdownOpen.course ? 'rotate-180' : 'rotate-0'
                }`}
                xmlns="http://www.w3.org/2000/svg"
                height="18px"
                viewBox="0 0 24 24"
            ...
            >
              <li
                className={url.startsWith('/admin/course') ? 'page-active' : ''}
              >
                <Link
                  href={route('admin.course.all')}
                  className="block px-4 py-2 hover:bg-gray-200"
                >
                  All Courses
                </Link>
          ...
          <li>
            <a href="dashboard-message.html">
              ...
              Message <span className="badge badge-info p-1 ml-2">2</span>
            </a>
          </li>
          <li>
          ...
          <li>
            <Link href={route('admin.change-password')}>
              <svg
                className="mr-2"
                xmlns="http://www.w3.org/2000/svg"
                height="18px"
