                ...
                <div className="mb-4">
                  <CCol>
                    ...
                    {errors.section_title && (
                      <CAlert color="danger">{errors.section_title}</CAlert>
                    )}
                  </CCol>
                  <div className="flex justify-center gap-4 mt-4">
                    <button
                      ...
                      disabled={processing}
                    >
                      {processing ? 'Loading...' : 'Add Section'}
                    </button>
                    <button
                      onClick={closeSectionModal}
          ...
          >
            ...
            <div className="flex justify-between items-center gap-4">
              ...
              <div>
                ...
                <button
                  onClick={() => handleDeleteModal('section', section.id)}
                  ...
                  {section.lectures.map((lecture, index) => (
                    ...
                    >
                      ...
                      <div className="flex gap-2 ">
                        <Link
                          onClick={(e) =>
                            EditLecture(e, lecture.id, section.id)
                          }
                          className="btn btn-primary "
                        >
                          Edit
                        ...
                        <button
                          onClick={() =>
                            handleDeleteModal('lecture', lecture.id)
                          }
                          className="btn btn-danger"
                        >
                          Delete
